...
class BlockCascade extends Component {
    ...
    render() {
        ...
        let blockTitleDefault =  defaultId === undefined || defaultId.content.title === undefined ? "Lorem ipsum dolor" : defaultId.content.title
        let DataId = this.getIndex(this.props.data,'id', `${this.props.id}`)

        let blockContentDefault = defaultId === undefined || defaultId.content.content === undefined   ? "Lorem ipsum dolor" : defaultId.content.content
        let blockIconDefault = defaultId === undefined || defaultId.content.icon === undefined   ? "book-open" : defaultId.content.icon

        return (
            <>
                <Editable dataId={`${this.props.id}`} dataType="block" openMenu={this.props.menuclose}>
                    <div>
